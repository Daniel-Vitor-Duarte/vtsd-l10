...
const CallToAction: React.FC = () => {
    ...
    return (
        <form
            className=" max-w-[30.375rem] w-full text-[#666] font-semibold"
            method="POST"
        ...
        >
            ...
            <button
                className={
                    "shadow-[0px_16px_40px_-16px_rgba(54,50,157,0.56)] rounded-lg flex items-center lg:justify-between justify-center lg:gap-2 gap-[.44rem] w-full bg-[#FFD52F] mt-[.5rem] lg:py-4 py-2 lg:px-5 px-3 text-[#0B112E] font-bold lg:text-[1.125rem] leading-[1.75rem]"
                }
            >
                <p>Quero participar</p>
                <Image className="lg:w-auto w-[1.125rem]" src={ArrowRight} alt="ArrowRight" />
            </button>
        </form>
    );
}
