            ...
            <section className=" mx-auto overflow-x-hidden bg-gradient">
                <section className="bg-[#0B112E] lg:py-[6.5rem] py-12">
                    <div className="max-w-[79.5rem]  mx-auto flex flex-col w-full items-center text-center">
                        <p className={`${SairaCondensed.className} lg:text-[2.5rem] text-[1.5rem] lg:leading-9 leading-7 text-white`}>
                            O destino te deu uma <br className="lg:hidden" /> segunda chance.
                        </p>
                        <h1
                            className=
                            {`${SairaCondensed.className} uppercase lg:mt-6 mt-4 lg:text-[5.5rem] text-[2rem] -tracking-[0.02rem] lg:leading-normal  leading-[2.75rem] text-[white] lg:-tracking-[0.055rem]`}
